...
@Entity(
    ...
    indices = [
        ...
        // sku es único por tienda, no global: dos sucursales pueden repetir un SKU.
        Index(value = ["tiendaId", "sku"], unique = true)
    ]
)
data class ProductoEntity(
    ...
    /** Sucursal dueña de este producto/variante. El inventario nunca se comparte entre tiendas. */
    val tiendaId: String,
